...
// const light2 = new THREE.AmbientLight(0xff0000, 1);
// light2.position.set(0, 300, 500);
// scene.add(light2);
// const light3 = new THREE.AmbientLight(0xff0000, 1);
// light3.position.set(500, 100, 0);
// scene.add(light3);
// const light4 = new THREE.AmbientLight(0xc4c4c4, 1);
// light4.position.set(0, 100, -500);
// scene.add(light4);
// const light5 = new THREE.AmbientLight(0xc4c4c4, 1);
// light5.position.set(-540, 300, 0);
// scene.add(light5);
...
// gui3.add(light3.target.position, 'y', 0, 10);
  ...
  // objLoader.setPath( 'model/' );
    objLoader.load('/model/ashapes_05.obj', function(object){
      // console.log(object);
      // scene.add(object);
      ...
      head2_2.position.x = 250;
      head2_2.position.y = 30;
      head2_2.position.z = 0;
    ...
    objLoader.load('model/ashapes_02.obj', function(object){
      ...
      head.material = new THREE.MeshPhongMaterial({map: textureHead, specular: 0xfceed2, bumpMap: mapHeightHead, bumpScale: 100, shininess: 100});
...
//       }, 1500);
      ...
      tl.from(camera.rotation,3,{
        y:(-0.5*Math.PI)-(0.5*Math.PI),
      },0);
      tl.restart();
      // tl.reverse();
